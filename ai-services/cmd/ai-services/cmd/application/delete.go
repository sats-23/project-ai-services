...
var deleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		klog.Infoln("Below are the list of pods to be deleted")
		for _, pod := range pods {
			klog.Infof("\t-> %s\n", pod.Name)
		}

		klog.Infof("Are you sure you want to delete above pods? (y/N): ")
